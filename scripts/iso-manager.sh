...
_usage() {
    ...
    echo "                 This option name will be removed in MetalK8s 123.1.0"
...
if [ -z ${ARCHIVE_DEPRECATED_OPTION+x} ]; then
  echo "Warning: Usage of the '--archive' option is deprecated, and will be removed" \
       "in the next MetalK8s minor version, 123.1.0. Please make sure to update your" \
